...
<main class="container-fluid bg-dark text-white min-h-screen p-4">
  <div class="px-4 py-5 my-5 text-center">
    <h1 class="display-5 fw-bold text-body-emphasis text-white animate__animated animate__rubberBand" style="color: white !important;">Posts</h1>
  </div>
    ...
    <div class="card-body">
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        <div class="table-responsive mb-3">
          <table class="table table-bordered table-dark" id="example" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th width="1%">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="addUserForm" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <span class="invalid-feedback text-white"><?php echo isset($error['title']) ? $error['title'] : ''; ?></span>
          </div>
          ...
          <div class="mb-3">
            ...
            <span class="invalid-feedback text-white"><?php echo isset($error['body']) ? $error['body'] : ''; ?></span>
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-select <?php echo (!empty($error['user_id'])) ? 'is-invalid' : ''; ?>" aria-label="Default select example" id="user_id" name="user_id" form="addUserForm">
              ...
              while ($row = mysqli_fetch_assoc($select_user_query)) :
                ...
                $user_name = $row['name'];
              ?>
                <option value="<?php echo $user_id; ?>" class="text-dark"><?php echo $user_name; ?></option>
              <?php endwhile; ?>
            </select>
